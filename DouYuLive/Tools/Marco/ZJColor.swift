...
// 主颜色
let kMainOrangeColor = UIColor(red: colorValue(238.0), green: colorValue(120.0), blue: colorValue(59.0), alpha: 1.0)
...
// 搜索框背景颜色
let kSearchBGColor = UIColor(red: colorValue(237.0), green: colorValue(143.0), blue: colorValue(90.0), alpha: 1.0)
// 渐变色色组
